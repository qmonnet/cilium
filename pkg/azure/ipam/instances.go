...
type AzureAPI interface {
	...
	GetVpcsAndSubnets(ctx context.Context) (ipam.VirtualNetworkMap, ipam.SubnetMap, error)
...
func newSubnetAlllocator(subnet *ipam.Subnet) (*subnetAllocator, error) {
...
func (m *InstancesManager) Resync(ctx context.Context) time.Time {
	...
	for id, subnet := range subnets {
		a, err := newSubnetAlllocator(subnet)
		if err != nil {
