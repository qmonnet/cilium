...
func (getter *LocalEndpointDNSGetter) GetEndpoint(ip net.IP) (endpoint *v1.Endpoint, ok bool) {
...
func (getter *LocalEndpointDNSGetter) GetNamesOf(sourceEpID uint64, ip net.IP) (fqdns []string) {
...
func (g *LocalServiceGetter) GetServiceByAddr(ip net.IP, port uint16) (service hubbleProto.Service, ok bool) {
	return hubbleProto.Service{}, false
}

func (g *LocalServiceGetter) GetServiceByID(id int64) (service hubbleProto.Service, ok bool) {
	return hubbleProto.Service{}, false
}
