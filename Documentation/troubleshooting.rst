...
You can download the latest version of the cilium-sysdump using the following
command:

.. code:: bash

    $ curl -sLO https://github.com/cilium/cilium-sysdump/releases/download/stable/cilium-sysdump.zip
